...
gSystem.Load('/cvmfs/ara.opensciencegrid.org/trunk/centos7/source/AraSim_debug/AraSim/libAra.so')
...
ROOT.gInterpreter.ProcessLine('#include "/cvmfs/ara.opensciencegrid.org/trunk/centos7/source/AraSim_debug/AraSim/RaySolver.h"')
raysolver = ROOT.RaySolver()

ROOT.gInterpreter.ProcessLine('#include "/cvmfs/ara.opensciencegrid.org/trunk/centos7/source/AraSim_debug/AraSim/signal.hh"')
signalPtr = ROOT.Signal(settingsPtr)
signalPtr.SetMedium(0)

ROOT.gInterpreter.ProcessLine('#include "/cvmfs/ara.opensciencegrid.org/trunk/centos7/source/AraSim_debug/AraSim/Tools.h"')
tools = ROOT.Tools()

# ROOT.gInterpreter.ProcessLine('#include "/cvmfs/ara.opensciencegrid.org/trunk/centos7/source/AraSim_debug/AraSim/Report.h"')
