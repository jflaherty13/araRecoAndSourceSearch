...
gSystem.Load("/cvmfs/ara.opensciencegrid.org/trunk/centos7/source/ARA_cvmfs/build/include/AraQualCuts.h")
...
for evNum in range(11914,totalEvents):#loop over events
    ...
    plt.savefig("/cvmfs/ara.opensciencegrid.org/trunk/centos7/source/ARA_cvmfs/source/AraRoot/analysis/ARA_analysis/ARA_SourceSearch/results/wforms/wf_ev%i.png"%rawEvent.eventNumber)
    ...
    plt.tight_layout(rect=[0.03, 0.03, 1, 0.95])
    plt.savefig("/cvmfs/ara.opensciencegrid.org/trunk/centos7/source/ARA_cvmfs/source/AraRoot/analysis/ARA_analysis/ARA_SourceSearch/results/wforms/spectra_ev%i.png"%rawEvent.eventNumber)
