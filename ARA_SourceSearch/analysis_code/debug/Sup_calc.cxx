...
int main(int argc, char **argv)
{
  ...
  char title[300];
  sprintf(title, "/cvmfs/ara.opensciencegrid.org/trunk/centos7/source/ARA_cvmfs/source/AraRoot/analysis/ARA_analysis/ARA_SourceSearch/analysis_code/debug/Sup.txt");
