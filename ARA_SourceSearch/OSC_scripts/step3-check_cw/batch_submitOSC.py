...
for year in range(2016,2017):
    ...
    f = open("/cvmfs/ara.opensciencegrid.org/trunk/centos7/source/ARA_cvmfs/source/AraRoot/analysis/ARA_analysis/ARA_SourceSearch/OSC_scripts/step3-check_cw/allRuns_A%i_%i.txt"%(station,year), "w+")
