...
for evNum in range(10,36):#loop over events
    ...
    plt.savefig("/cvmfs/ara.opensciencegrid.org/trunk/centos7/source4/ARA_cvmfs/source/AraRoot/analysis/thesis_work_daily/plots/SpiceCorePolReco/wf_all_ev%i.pdf"%evNum)
    plt.close('all')
