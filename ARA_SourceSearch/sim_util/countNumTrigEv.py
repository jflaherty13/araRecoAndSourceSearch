...
# gInterpreter.ProcessLine('#include "/cvmfs/ara.opensciencegrid.org/trunk/centos7/source/AraSim/IceModel.h"')
...
#file_list.append("/cvmfs/ara.opensciencegrid.org/trunk/centos7/source/AraSim/outputs/AraOut.setupExample.txt.run1.root")
