...
year = 2014
isSim = 0
anaFolder = os.path.expanduser('/cvmfs/ara.opensciencegrid.org/trunk/centos7/source/ARA_cvmfs/source/AraRoot/analysis/ARA_analysis/ARA_SourceSearch/')
...
for year in range(2013,2017):
    ...
    f = open("/cvmfs/ara.opensciencegrid.org/trunk/centos7/source/ARA_cvmfs/source/AraRoot/analysis/ARA_analysis/ARA_SourceSearch/OSC_scripts/step2-make_run_summary/allRuns_A%i_%i.txt"%(station,year), "w+")
