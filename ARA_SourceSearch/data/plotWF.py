...
for evNum in range(14300,totalEvents):#loop over events
    ...
    plt.savefig("/cvmfs/ara.opensciencegrid.org/trunk/centos7/source/ARA_cvmfs/source/AraRoot/analysis/thesis_work_daily/plots/SpiceCorePolReco/wf_all_run%s_ev%i.png"%(run,evNum))
    plt.close('all')
    # sys.exit()
