...
int main(int argc, char **argv)
{
	...
	char filename[50];
	sprintf(filenameVertex, "./cvmfs/ara.opensciencegrid.org/trunk/centos7/source/ARA_cvmfs/source/AraRoot/analysis/files/source_optimization/bkg_random_SNR_%0.3f.csv", sol_Name[ray_sol_cnt]);
