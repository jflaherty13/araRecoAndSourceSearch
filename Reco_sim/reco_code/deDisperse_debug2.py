...
Interpol = pd.read_csv("/cvmfs/ara.opensciencegrid.org/trunk/centos7/source/AraSim/outputs/interp.csv")
InterpolV = pd.read_csv("/cvmfs/ara.opensciencegrid.org/trunk/centos7/source/AraSim/outputs/interpV.csv")
