...
for f in $FILES
  do
    (
      ./analysis_filter 1 2 1 /fs/project/PAS0654/ARA_DATA/A23/sim_SourceSearch/A2/RunSummary /cvmfs/ara.opensciencegrid.org/trunk/centos7/source/ARA_cvmfs/source/AraRoot/analysis/ARA_analysis/Reco_sim/reco_code/Interf_files/filter_files "$f" XX
    )&
