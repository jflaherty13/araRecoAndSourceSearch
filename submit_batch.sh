...
for i in "${arr[@]}"
do
    AraSimDir='/cvmfs/ara.opensciencegrid.org/trunk/centos7/source/ARA/AraSim/AraSim_versions/ARA03_type_2'
    SetUpFile='/cvmfs/ara.opensciencegrid.org/trunk/centos7/source/ARA/AraSim/AraSim_versions/setups/monoE/A3_c2_E'$i'.txt'
